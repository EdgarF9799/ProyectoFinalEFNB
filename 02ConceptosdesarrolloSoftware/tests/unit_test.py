...
def test_outlierfix_transform():
    ...
    data = {'col1': [5, 100, 15, 20, 250, 30, 35, 400],
            'col2': [100, 200, 300, 400, 500, 600, 700, 800]}
...
def test_custom_value_fixed_transform():
    ...
    data = {'sc_w': [5, 10, 1.5, 2.0, 2.5, 3, 3.5, 4.0],  # 30
            'px_height': [100, 200, 300, 500, 700, 900, 1000, 1200]}
    df = pd.DataFrame(data)
...
def test_csv_file_existence():
    ...
    csv_file_path = "C:\Users\Edgar F\Desktop\000MLOPS\02ConceptosdesarrolloSoftware\my_project\data\train.csv"
...
def test_pkl_file_existence():
    ...
    pkl_file_path = "C:\Users\Edgar F\Desktop\000MLOPS\03DesarrolloModelosML\Models\SVM_output.pkl"
